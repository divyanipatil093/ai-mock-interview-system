    ...
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
        ...
        border border-gray-200 px-8 py-4 flex justify-between items-center relative'>
            <div className='flex items-center gap-3 cursor-pointer'>
                ...
                <h1 className='font-semibold hidded md:block 
            ...
            <div className='flex items-center gap-6 relative'>
                <div className='relative'>
                    ...
                    gap-2 bg--gray-100 px-4 py-2 rounded-full text-md hover:bg-gray-200'>
                        <BsCoin size={20}/>
                        {userData?.credits||0}
                    </button>
                    {showCreditPopup && (
                        <div className='absolute right-[-50px] mt-3 w-64 bg-white shadow-xl 
                        border-gray-200 rounded-lg p-5 z-50'>
                ...
                <div className='relative'>
                    ...
                    {showUserPopup && (
                        ...
                        bg-white shadow-xl border-gray-200 rounded-xl p-4 z-50'>
                            <p className='text-md text-blue-500 font-medium mb-1'>{userData?.name}</p>

                            <button onClick={() => navigate('/history')}
                            className='w-full text-left py-2 text-sm text-gray-600 hover:text-black'>Interview History</button>
