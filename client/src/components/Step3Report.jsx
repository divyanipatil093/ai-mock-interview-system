...
function Step3Report({ report }) {
    ...
    const downloadPDF = () => {
        ...
        if (finalScore >= 8) {
            advice = 
            `Excellent performance. Maintain confidence and structure. Continue refining clarity 
    ...
    return (
        <div className="min-h-screen bg-linear-to-r from-gray-50 to-green-50 px-4 sm:px-6 
        lg:px-10 p-8">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center
            sm:justify-beteen gap-4">
                ...
                px-3 rounded-xl shadow-md transition-all duration-300 font-semibold
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className="space-y-6">
                    ...
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="bg-white rounded-2xl sm:rounded-3xl shadow-l
                     p-6 sm:p-8">
