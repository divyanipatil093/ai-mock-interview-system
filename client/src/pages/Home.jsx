        ...
        <div className='text-center mb-2'>
            ...
            className='text-4xl md:text-6xl font-semibold leading-tight max-w-4xl mx-auto'>
              ...
              <span className='relative inline-block'>
                <span className='bg-green-100 text-green-600 px-5 py-0.9 rounded-full'>
                  AI Intelligence
                </span>
              </span>
            </motion.h1>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mt-20 mb-28'>
            {
              [
                {
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc:"Detailed strengths, weaknesses and improvement insight."
                  },
                  {
                    image: hrImg,
                    icon:<BsBarChart size={20}/>,
                    ...
                    shadow-sm hover:shadow-xl transition-all'>
                      <div className='flex flex-col md:flex-row items-center gap-8'>
                        ...
                        <div className='bg-green-50 text-green-600 w-12 h-12 rounded-xl flex
