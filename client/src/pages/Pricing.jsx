                ...
                {plans.map((plan) => {
                    ...
                    return (
                        <motion.div key={plan.id}
                            ...
                            onClick={() => !plan.default && setSelectePlan(plan.id)}
                        ...
                        >
                            ...
                            {/* Badge */}
                            {plan.badge && (
                                <div className="absolute top-6 right-6 bg-emerald-600 text-white 
                            ...
                            {/* Default Tag */}
                            {plan.default && (
                                <div className="absolute top-6 right-6 bg-gray-200 text-gray-700 
                            ...
                            {!plan.default &&
                                ...
                                className={`w-full mt-8 py-3 rounded-xl font-semibold
                                    transtion ${
                                        isSelected
                                        ? "bg-emerald-600 text-white hover:opacit-90"
